                                    ...
                                    <div className="form-group" style={{ marginBottom: '1rem' }}>
                                        <div className="form-check">
                                            <label className="form-check-label">
                                                <input type="checkbox" className="form-check-input" checked={props.options.prcessRootUrlOnly}  onClick={(e) => {
                                                    let value = !props.options.prcessRootUrlOnly;
                                                    props.setOptions({...props.options, prcessRootUrlOnly:  value});
                                                    localStorage.setItem("prcessRootUrlOnly", value);
                                                }} /> Process Root Url Only <i className="input-helper"></i> <small className="text-muted">| {props.options.prcessRootUrlOnly ? 'www.example.com' : 'www.example.com/xyz'} |</small>
                                            </label>
                                        </div>
                                    </div>
                                </div>
